...
import 'package:weathergo/our_themes.dart';
import 'images.dart';
import 'package:weathergo/string.dart';
import 'package:weathergo/controllers/main_controller.dart';
import 'services/api_service.dart';
import 'models/hourly_weathermodel.dart';
void main() {
  runApp(const App());
}
                        ...
                        children: [
                          ...
                          RichText(
                            ...
                            children: [
                              TextSpan(
                                  text:
                                      "${data.main!.temp.toInt() - 273}$degree",
                                  style: TextStyle(
                                    color: theme.primaryColor,
                                    fontSize: 64,
                                    fontFamily: "poppins",
                        ...
                        children: [
                          TextButton.icon(
                              ...
                              icon: Icon(Icons.expand_less_rounded,
                                  color: theme.iconTheme.color),
                              label:
                                  "${(data.main!.tempMax - 273).ceil()}$degree"
                                      .text
                                      .color(theme.iconTheme.color)
                                      .make()),
                          TextButton.icon(
                              ...
                              icon: Icon(Icons.expand_more_rounded,
                                  color: theme.iconTheme.color),
                              label:
                                  "${(data.main!.tempMin - 273).floor()}$degree"
                                      .text
                                      .color(theme.iconTheme.color)
                                      .make())
                        ],
                                  ...
                                  return Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        10.heightBox,
                                        "${hourlyData.list![index].main!.temp!-273}$degree".text.make(),
                                      ],
                                    ),
                                  );
                                },
